...
<head>
    ...
    <link rel="stylesheet" href="../style/indexmasyarakat.css">
    <title>SIPADU</title>
</head>
...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="header_img">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9U3kAT8-QOWyzlekr4HzYrxU9OVFlxU89rA&s" alt="">
        </div>
    </header>
    ...
    <!-- Include JS Files -->
    <script src="../js/indexmasyarakat.js"></script>
